...
class EventHandlerFactory
{
     ...
     * @return \Kount\Ris\Model\Ens\EventHandlerInterface
    ...
    public function create($handlerCode)
    {
        ...
        if (!$eventHandler instanceof EventHandlerInterface) {
            throw new \InvalidArgumentException(get_class($eventHandler) . ' must be an instance of \Kount\Ris\Model\Ens\EventHandlerInterface.');
        }
        return $eventHandler;
    }
}
