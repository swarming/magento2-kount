...
use Kount\Ris\Model\Config\Log;
...
class Settings
{
    ...
    /**
     * @var \Kount\Ris\Model\Config\Log
     */
    protected $configLog;
    ...
    public function __construct()
    {
        ...
        $this->configAccount = $objectManager->get(\Kount\Ris\Model\Config\Account::class);
        $this->configLog = $objectManager->get(\Kount\Ris\Model\Config\Log::class);
