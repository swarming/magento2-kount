 ...
 */
namespace Kount\Ris\Block\Adminhtml\System\Config;

use Magento\Config\Block\System\Config\Form\Field;
use Magento\Framework\Data\Form\Element\AbstractElement;
use Magento\Framework\App\Filesystem\DirectoryList;
use Kount\Ris\Model\Config\Log as ConfigLog;
...
class Log extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        if ($dir->isFile('log/' . ConfigLog::FILENAME)) {
            $html = '<a id="' . $element->getHtmlId() . '" href="' . $this->getUrl('kount_ris/config/log') . '">' . __('Download') . '</a>';
        } else {
